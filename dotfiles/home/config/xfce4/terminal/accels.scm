...
(gtk_accel_path "<Actions>/terminal-window/undo-close-tab" "<Primary>d")
...
(gtk_accel_path "<Actions>/terminal-window/set-title" "<Primary>s")
...
(gtk_accel_path "<Actions>/terminal-window/paste-alt" "<Primary>Insert")
